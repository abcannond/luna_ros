...
Eyeball the streams (X11 forwarding or local display required):
...
| No "marker detected" log at all | Wrong dictionary, wrong ID, or marker too small/far. Confirm the print is `DICT_4X4_50` ID 50 and try at ~1 m, well lit. |
