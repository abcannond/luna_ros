...
### One-liner (Artemis + mapping + Nav2)

```bash
cd /ros2_ws && source install/setup.bash
ros2 launch lunabot_2425 competition_cycle_sim.launch.py
```
...
Use **`competition_cycle_sim.launch.py`** when you want **one terminal** for CI and quick student demos.
